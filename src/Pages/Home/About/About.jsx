        ...
        <div id="about" className="bg-[#050810]">
            <div className="w-11/12 mx-auto">
                ...
                <div className="md:flex items-center text-white  pb-32 gap-10">
                    <div data-aos="zoom-in"><img className="border-[#10E956] border-2 rounded-md md:w-[300px] md:h-[370px]" src="https://i.ibb.co/W32m5K2/1675699780981.jpg" alt="profile" /></div>
                    <div data-aos="zoom-in" className="pt-10 md:w-4/5"><p className="texl-sm md:text-md font-mono">My name is Md. Ashraful Islam, and I am currently study Green University of Bangladesh department of Computer Science and Engineering.I have a strong interest in problem-solving and enjoy finding creative solutions to challenging tasks.
                    <br/>
